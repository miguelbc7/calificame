...
return [
    ...
    */
    // -------------------------Index mensajes-------------------------
        ...
        //Slogan mensajes
        'slogan' => 'Encuestas fáciles para tu restaurante.',
        'subslogan' => 'Tus clientes opinan desde su móvil de forma privada y tú mejoras tu negocio.',
        ...
        'plansubslogan' => 'Sin dar tus datos de pago, sin permanencia ni obligaciones.',
        'plan1' => 'Plan Básico',
        'subplan1' => '',
        'price1' => '10€/USD al mes',
        'subprice1' => 'por establecimiento',
        'plandes1.1' => 'Crea encuestas de hasta 6 preguntas',
        'plandes1.2' => 'Recibe la opinión de tus clientes en tu e-mail',
        'plandes1.3' => 'Responde a las opiniones de tus clientes',
        'plandes1.4' => 'Resumen semanal de los resultados',
        'planbutton1' => 'Pruébalo gratis 30 días',
        'plan2' => 'Plan 24/7',
        'subplan2' => 'por establecimiento',
        'price2' => '$400 mensuales',
        'subprice2' => '',
        'plandes2.1' => 'Crea tus propias preguntas',
        'plandes2.2' => 'Alertas inmediatas por e-mail de cualquier queja de tus clientes',
        'plandes2.3' => 'Resultados y estadísticas semanales',
        'plandes2.4' => 'Obtén la dirección de e-mail de tus clientes y mándales tus promos',
        'planbutton2' => 'Pruébalo gratis 30 días',
        'plan3' => 'Plan Premium',
        'subplan3' => '',
        'price3' => 'Contáctanos',
        'subprice3' => 'para saber más',
        'plandes3.1' => 'Todas las funcionalidades del Plan Pro',
        'plandes3.2' => 'Soporte técnico premium por e-mail y por teléfono',
        'plandes3.3' => 'Generación de reportes personalizados',
        'plandes3.4' => 'Informe trimestral del sector hostelero',
        ...
        'section15' => 'Asimismo, EMTRICS, S.L. no garantiza que las empresas titulares de los servicios hagan caso de las opiniones o contesten a las reclamaciones de los Usuarios.',
        'section16' => 'Finalmente, EMTRICS, S.L. no se hace responsable de ningún tipo de reclamación que eventualmente pudiera interponerse, como consecuencia de la adquisición de los productos o servicios de las empresas Clientes, de sus mensajes publicitarios o de los procesos de sugerencias o reclamaciones iniciados directamente a través del sitio web o por cualquier otro medio.',

        'title4' => 'Copyright y Propiedad del Contenido',
        'section17' => 'Excepto cuando se indique lo contrario, el aspecto y comportamiento del Servicio es copyright de © EMTRICS, SL. Todos los derechos reservados. Usted no puede duplicar, copiar o reutilizar ninguna parte del código HTML, CSS, JavaScript, o elementos del diseño visual sin autorización expresa por escrito de EMTRICS, SL.',
        'section18' => 'No reclamamos derechos de propiedad intelectual sobre logotipos o cualquier otro material que pueda subir un Cliente. Todos los materiales subidos por un Cliente siguen siendo de su propiedad.',

        'title5' => 'Créditos',
        'list1' => 'Todos los logos y marcas registradas en los iconos de las redes sociales son propiedad de los de los titulares de las respectivas marcas.®',
        'list2' => 'Iconos diseñados y licenciados por Glyphicons.',
        'list3' => 'Icono del folleto diseñado por Rodolfo Alvarez del The Noun Project.',
        'list4' => 'Icono del Globo diseñado por Richard Schumann del The Noun Project.',
        ...
        'title6' => 'Política y Privacidad de Datos',
        ...
        'title8' => 'Uso de cookies y del fichero de actividad',
        'section27' => 'El Prestador por su propia cuenta o la de un tercero contratado para la prestación de servicios de medición, pueden utilizar cookies cuando un usuario navega por el sitio web. Las cookies son ficheros enviados al navegador por medio de un servidor web con la finalidad de registrar las actividades del Usuario durante su tiempo de navegación.',
        'section28' => 'Las cookies utilizadas por el sitio web se asocian únicamente con un usuario anónimo y su ordenador, y no proporcionan por sí mismas los datos personales del Usuario.',
        'section29' => 'Mediante el uso de las cookies resulta posible que el servidor donde se encuentra la web, reconozca el navegador web utilizado por el usuario con la finalidad de que la navegación sea más sencilla, permitiendo, por ejemplo, el acceso a los usuarios que se hayan registrado previamente, acceder a las áreas, servicios, promociones o concursos reservados exclusivamente a ellos sin tener que registrarse en cada visita. Se utilizan también para medir la audiencia y parámetros del tráfico, controlar el progreso y número de entradas.',
        'section30' => 'El usuario tiene la posibilidad de configurar su navegador para ser avisado de la recepción de cookies y para impedir su instalación en su equipo. Por favor, consulte las instrucciones y manuales de su navegador para ampliar esta información.',
        'section31' => 'Para utilizar el sitio web, no resulta necesario que el usuario permita la instalación de las cookies enviadas por el sitio web, o el tercero que actúe en su nombre, sin perjuicio de que sea necesario que el usuario inicie una sesión como tal en cada uno de los servicios cuya prestación requiera el previo registro o “login”.',
        'section32' => 'Las cookies utilizadas en este sitio web tienen, en todo caso, carácter temporal con la única finalidad de hacer más eficaz su transmisión ulterior. En ningún caso se utilizarán las cookies para recoger información de carácter personal.',

        'title9' => 'Direcciones IP',
        'section33' => 'Los servidores del sitio web podrán detectar de manera automática la dirección IP y el nombre de dominio utilizados por el usuario. Una dirección IP es un número asignado automáticamente a un ordenador cuando ésta se conecta a Internet. Toda esta información es registrada en un fichero de actividad del servidor debidamente inscrito que permite el posterior procesamiento de los datos con el fin de obtener mediciones únicamente estadísticas que permitan conocer el número de impresiones de páginas, el número de visitas realizadas a los servicios web, el orden de visitas, el punto de acceso, etc.',

        'title10' => 'Seguridad',
        'section34' => 'El sitio web utiliza técnicas de seguridad de la información generalmente aceptadas en la industria, tales como firewalls, procedimientos de control de acceso y mecanismos criptográficos, todo ello con el objeto de evitar el acceso no autorizado a los datos. Para lograr estos fines, el Usuario o Cliente acepta que el prestador obtenga datos para efectos de la correspondiente autenticación de los controles de acceso.',
        ...
        'section37' => 'Asimismo, el acceso o la utilización mencionados implican que usted es mayor de edad, con capacidad suficiente para contratar y con poder de representación suficiente en caso de actuar en nombre de persona jurídica.',
        'section38' => 'Se entiende por Cliente la persona natural o jurídica que, mediante la aceptación de las presentes Condiciones Generales del Servicio, manifiesta su intención y voluntad de utilizar los servicios de EMTRICS, S.L. para la realización de encuestas de satisfacción entre los clientes y usuarios de sus servicios, como medio para la mejora de sus explotaciones empresariales o profesionales. Se entiende por Usuario aquella persona física que hace uso de los medios técnicos y soportes que EMTRICS, S.L.pone a disposición del Cliente con el fin de responder a las encuestas de satisfacción diseñadas.',
        'section39' => 'Este es, por tanto, un contrato legal entre el Cliente y EMTRICS, S.L. para la prestación de servicios de encuestas de satisfacción y tratamiento de datos. Estos servicios incluyen el software, los mecanismos de almacenaje de datos, las bases de datos y los diseños relacionados, los materiales impresos, la creación y redacción de cuestionarios de preguntas, la creatividad de los materiales a imprimir y toda la documentación en línea y/o documentación electrónica.',
        'section40' => 'El Cliente podrá aceptar las presentes Condiciones:',
        'list13' => '1. haciendo clic en el botón de aceptación de las Condiciones, cuando se le ofrezca esta opción; o',
        'list14' => '2. procediendo a registrase o a acceder mediante las claves de identificación necesarias al área de clientes; o',
        'list15' => '3. utilizando de forma activa los Servicios. En este caso, el Cliente afirma entender y aceptar que, a partir de ese momento, EMTRICS S.L. considerará su utilización de los Servicios como una aceptación expresa de las Condiciones de Uso.',
        ...
        'section55' => 'El Cliente expresamente declara conceder a EMTRICS, S.L. autorización general, sin contraprestación de ningún tipo, para utilizar los logotipos, marcas o cualquier otro diseño incluyendo texto y/o gráficos, que sean propiedad del Cliente, para la realización y prestación de los servicios contratados.',
        'section56' => 'El Cliente autoriza expresamente a EMTRICS, S.L. para utilizar su marca y nombre comercial como referencia para la promoción de sus servicios, salvo comunicación fehaciente en contrario.',
        'section57' => 'Asimismo, en caso de utilización de logotipos, marcas o cualquier otro diseño incluyendo texto y/o gráficos sobre los que el Cliente no tenga atribuidos, por cualquier causa o título, los derechos de propiedad y/o uso, el Cliente declara expresamente exonerar a EMTRICS, S.L. de cualquier responsabilidad derivada del mencionado uso, utilización o reproducción, asumiendo cualquier responsabilidad o indemnización que pudiera derivarse por tales situaciones.',

        'title18' => 'Utilización del website bajo la exclusiva responsabilidad del Cliente',
        'section58' => 'El Cliente declara expresamente entender y aceptar que la utilización del website y de los servicios en él prestados se realizará bajo su única y exclusiva responsabilidad.',
        'section59' => 'Asimismo, el Cliente se compromete a utilizar los servicios que presta EMTRICS, S.L. de acuerdo a las condiciones expuestas, y, en general, de acuerdo a las buenas costumbres y al orden público.',
        'section60' => 'El Cliente se compromete a no utilizar los servicios con finalidades ilegales o de forma que se lesionen derechos de terceros.',
        'section61' => 'El Cliente responderá de todos los daños y perjuicios, de cualquier naturaleza, que EMTRICS, S.L. pueda sufrir como consecuencia del uso indebido por parte de los usuarios de los servicios prestados y de los contenidos insertados en el website. El Cliente se compromete a abonar cualquier eventual cantidad que EMTRICS, S.L. deba hacer efectiva como consecuencia de una resolución administrativa, sentencia judicial firme o acuerdo transaccional tendente a resarcir a terceros de los daños ocasionados por el uso indebido, o contrario a los presentes términos, por cualquiera de los usuarios del Cliente.',
        'section62' => 'EMTRICS, S.L., se reserva el derecho de suspender provisional o definitivamente el servicio en el momento en que detecte que el Cliente:',
        'list20' => 'Vulnera cualquiera de los términos y apartados de las presentes Condiciones de Uso del Servicio.',
        'list21' => 'Suministra o ha suministrado datos falsos o inexactos al rellenar el formulario de registro.',
        'list22' => 'Suministra direcciones de correo electrónico o números de teléfonos móviles falsos o inexistentes.',
        'list23' => 'No registra ninguna actividad ni accede a su área personal en el periodo de un (1) año.',
        'list24' => 'No se encuentra al corriente de los pagos de servicio.',
        ...
        'section72' => 'El Cliente podrá dar por terminada la relación contractual en cualquier momento mediante comunicación fehaciente a EMTRICS, S.L., La comunicación por medio fehaciente de la voluntad de terminación surtirá efectos en un plazo de VEINTICUATRO HORAS a partir de su recepción. En este caso, el Cliente declara expresamente renunciar, en concepto de resarcimiento, a cualquier devolución, total o parcial, de posibles cantidades anticipadas abonadas a EMTRICS SL,.',
        'section73' => 'EMTRICS, S.L., podrá dar por terminada la relación contractual por cualquier causa derivada de las necesidades de prestación de los servicios. En este caso, el Cliente tendrá derecho a la devolución, en su caso, de la parte de la cantidad pagada correspondiente al periodo de tiempo de servicio no consumido como consecuencia de tal terminación.',
        'section74' => 'Igualmente, EMTRICS, S.L., podrá dar por terminada la relación contractual por incumplimiento por parte del Cliente de cualquier obligación derivada de las presentes Condiciones Generales de Servicio o cualquier otra norma o disposición legal aplicable, o por cualquier conducta del Cliente que pudiera suponer un riesgo para la normal prestación de los servicios de EMTRICS, S.L, Los efectos de terminación del contrato por parte de EMTRICS, S.L. serán automáticos y tendrán efectividad inmediata, sin necesidad de comunicación previa de ninguna naturaleza, y conllevarán igualmente aparejada la pérdida de cualquier pago realizado o cantidad anticipada entregada, y la renuncia expresa por parte del Cliente a su devolución.',
        ...
        'title25' => 'Ley aplicable y jurisdicción',
        'section78' => 'Estas condiciones se regirán o interpretarán conforme a la legislación española en aquello que no esté expresamente establecido en este documento.',
        'section79' => 'Dado que el Cliente no ostenta la condición de consumidor y no resulta en consecuencia aplicable las posibles reservas de fuero establecidas en las normativas de consumidores, EMTRICS, S.L., y el Cliente acuerdan someter cualquier controversia que pudiera suscitarse de la prestación del Servicio objeto de éstas Condiciones, a los Juzgados y Tribunales de Madrid, con renuncia expresa de cualquier otro fuero que pudiera corresponderle, aún para el caso de que el Cliente tenga su domicilio fuera de España.',
        'section80' => 'A estos efectos, el Cliente declara expresamente conocer que la actividad de EMTRICS, S.L. se encuentra sometida al ordenamiento jurídico español, aun cuando el website se encuentre disponible, para mayor comodidad del Cliente, en varios idiomas.',
];
