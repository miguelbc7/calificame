...
<div class="section whycalificame" id="why-calificame">
  <div class="w-container">
    <div class="legal-text w-richtext">
      ...
      <h1>{{ Lang::get('message.title1') }}</h1>
      <p>{{ Lang::get('message.section1') }}</p>
      <p>{{ Lang::get('message.section2') }}/p>
      <p>{{ Lang::get('message.section3') }}</p>
      <p>{{ Lang::get('message.section4') }}</p>
      <p>{{ Lang::get('message.section5') }}</p>
      <p>{{ Lang::get('message.section6') }}</p>
      <p>{{ Lang::get('message.section7') }}</p>
      <p>{{ Lang::get('message.section8') }}</p>
      
      <h2>{{ Lang::get('message.title2') }}</h2>
      <p>{{ Lang::get('message.section9') }}</p>
      <p>{{ Lang::get('message.section10') }}</p>
      <p>{{ Lang::get('message.section11') }}</p>
      <p>{{ Lang::get('message.section12') }}</p>
      <p>{{ Lang::get('message.section13') }}</p>
      
      <h2>{{ Lang::get('message.title3') }}</h2>
      <p>{{ Lang::get('message.section14') }}</p>
      <p>{{ Lang::get('message.section15') }}</p>
      <p>{{ Lang::get('message.section16') }}</p>
      
      <h2>{{ Lang::get('message.title4') }}</h2>
      <p>{{ Lang::get('message.section17') }}</p>
      <p>{{ Lang::get('message.section18') }}</p>

      <h3>{{ Lang::get('message.title5') }}</h3>
      <ul>
        <li>{{ Lang::get('message.list1') }}</li>
        <li>{{ Lang::get('message.list2') }}</li>
        <li>{{ Lang::get('message.list3') }}</li>
        <li>{{ Lang::get('message.list4') }}</li>
        <li>{{ Lang::get('message.list5') }}</li>
      </ul>
