			...
			<div class="box">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
						<a href="{{ route('trendsQuestions', $surveys->id)}}" class="btn btn-primary">Tendencias Generales de Preguntas</a>
					</div>
					<div class="form-group col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
						<a href="{{ route('trendsSatisfaction', $surveys->id)}}" class="btn btn-primary">Tendencias Generales de Satisfaccion</a>
					</div>
				</div>
				<div class="col-md-6">
				...
				{!!Form::model($surveys,['route'=>['trendsDateQuestions',$surveys],'method'=>'PUT', 'files' => true])!!}
				...
				{!!Form::model($surveys,['route'=>['trendsDateSatisfaction',$surveys],'method'=>'PUT', 'files' => true])!!}
				<div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="row">
						<div class="col-xs-1 col-sm-1 col-md-6 col-lg-12 col-xl-12">
							<div data-toggle="tooltip" title data-original-title="La fecha de inicio de la busqueda">
