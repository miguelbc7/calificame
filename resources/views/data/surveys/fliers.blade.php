...
@section('main-content')
    <div style="padding-right: 15px; padding-left: 15px;margin-right: 50px;margin-left: 50px;margin-top: 50px; border: 1px solid #000;">
        ...
        <div style="margin-right: -15px; margin-left: -15px;">
            ...
            <div style="padding-right: 15px; padding-left: 15px;"><h3 style="margin: 0 auto;text-align: center;"><a href="{{ url('surveys/'.$surveys->id.'/survey') }}">calificame.mx/79</a></h3></div>
